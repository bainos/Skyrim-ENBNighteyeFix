...
technique11 Draw <string UIName="RUDY ENB DEFAULT";>
{
   pass p0
   {
...
technique11 Preset1 <string UIName="RUDY ENB VARIANT 1";>
{
   pass p0
   {
      SetVertexShader(CompileShader(vs_5_0, VS_Draw()));
...
technique11 Preset2 <string UIName="RUDY ENB VARIANT 2";>
{
   pass p0
   {
      SetVertexShader(CompileShader(vs_5_0, VS_Draw()));
...
technique11 Preset3 <string UIName="RUDY ENB VARIANT 3";>
{
   pass p0
   {
      SetVertexShader(CompileShader(vs_5_0, VS_Draw()));
